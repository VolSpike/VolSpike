        ...
        <main className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8">
              ...
              <section className="p-6 rounded-lg border border-border bg-muted/30">
                <h2 className="text-2xl font-semibold mb-4">Subscriptions & Billing</h2>
                <ul className="list-disc ml-4 text-muted-foreground space-y-2">
              ...
              <section className="p-6 rounded-lg border border-border bg-muted/30">
                <h2 className="text-2xl font-semibold mb-4">Downgrades & Upgrades</h2>
                <ul className="list-disc ml-4 text-muted-foreground space-y-2">
              ...
              <section className="p-6 rounded-lg border border-border bg-muted/30">
                ...
                <p className="text-muted-foreground mb-3">
                  ...
                  <a className="text-brand-600 hover:text-brand-700 font-semibold" href="mailto:support@volspike.com">support@volspike.com</a>{' '}
